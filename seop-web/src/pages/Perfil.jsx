...
import { User, Lock, Save, ShieldCheck, KeyRound, Eye, EyeOff } from 'lucide-react';
...
function Perfil() {
    ...
    async function handleTrocarSenha(e) {
        ...
        setLoading(true);
        try {
            // Tenta usar o ID do contexto, se não tiver, usa o ID salvo no localStorage
            ...
            await api.put(`/usuarios/${idUsuario}/senha`, {
                senhaAntiga,
                novaSenha
            });
            ...
            <div className="flex-1 md:ml-64 p-8 overflow-y-auto h-full">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 flex flex-col items-center text-center h-fit">
                        ...
                        {user?.role}
                            ...
                            <div className="mt-8 w-full pt-8 border-t border-gray-100 flex flex-col gap-3 text-sm text-gray-500">
                                ...
                                <div className="flex justify-between"><span>Acesso</span> <span>Total</span></div>
                            </div>
                        </div>
                            ...
                            <form onSubmit={handleTrocarSenha} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type={showAntiga ? "text" : "password"}
                                            value={senhaAntiga}
                                            onChange={e => setSenhaAntiga(e.target.value)}
                                            className="w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition"
                                            placeholder="Digite sua senha atual"
                                            required
                                        />
                                        <button type="button" onClick={() => setShowAntiga(!showAntiga)} className="absolute right-3 top-3 text-gray-400 hover:text-gray-600">
                                            {showAntiga ? <EyeOff size={18}/> : <Eye size={18}/>}
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <button type="button" onClick={() => setShowNova(!showNova)} className="absolute right-3 top-3 text-gray-400 hover:text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                required
                                            />
                                            <button type="button" onClick={() => setShowConfirmar(!showConfirmar)} className="absolute right-3 top-3 text-gray-400 hover:text-gray-600">
                                ...
                                <div className="pt-4 flex justify-end">
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-200 transition transform hover:-translate-y-1 disabled:opacity-70"
                                    >
